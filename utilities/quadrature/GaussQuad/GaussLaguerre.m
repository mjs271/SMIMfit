...
%===============================================================================
%
% This function provides the points and weights for a Gauss-Laguerre quadrature
% method. This script comes from the Matlab File Exchange:
% https://www.mathworks.com/matlabcentral/fileexchange/26737-legendre-laguerre-and-hermite-gauss-quadrature
%
%===============================================================================
%
% Inputs:
%   n     := degree of Laguerre polynomial to be employed
%   alpha := generalized Laguerre polynomial parameter--alpha = 0 is simple version
%
% Outputs:
%   x := points for evaluating the method
%   w := weights for evaluating the method
%
%===============================================================================
%===============================================================================
